    ...
    <>
      <section className="relative w-full py-16 overflow-hidden bg-[#f5dec0]">
        <div className="flex flex-col items-center justify-center relative max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <span className="text-[#615252] text-xl md:text-2xl lg:text-3xl mt-4 font-medium">
            Andy Warhol
          </span>
        </div>
        <div
        ...
        >
          <p
            className="text-[#615252] text-md sm:text-lg md:text-2xl lg:text-2xl max-w-[600px] w-[75%] text-center
          font-medium"
          >
        ...
        <div className="flex justify-center mt-8 sm:mt-12">
          <Link href={"/portfolio"}>
            <button
              className="text-[#615252] font-medium text-base sm:text-lg md:text-xl lg:text-2xl border border-[#615252] px-6 py-2 rounded transition
             hover:bg-[#615252] hover:text-white cursor-pointer w-fit"
            >
              View My Work
            </button>
          </Link>
