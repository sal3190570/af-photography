  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col items-center w-full h-full bg-white sm:h-[600px] sm:w-[380px] sm:rounded-xl outline-none p-6">
        ...
        {/* Title */}
        <h2 className="mt-20 sm:mt-6 text-4xl font-bold mb-8">Sign Up</h2>
        ...
        <div className="flex flex-col items-center space-y-4 w-full">
          <button className="flex flex-row items-center w-[250px] h-10 rounded-2xl text-[16px] font-medium cursor-pointer hover:-translate-y-1 transition">
            ...
            <span className="flex-1 text-left pl-2">Sign Up With Google</span>
          </button>

          <button className="flex flex-row items-center w-[250px] h-10 rounded-2xl text-[16px] font-medium cursor-pointer hover:-translate-y-1 transition ">
            <div className="flex justify-center items-center w-10">
              <Image src="/apple.svg" height={18} width={18} alt="Apple Logo" />
            </div>
            <span className="flex-1 text-left pl-2">Sign Up With Apple</span>
          </button>
        </div>
